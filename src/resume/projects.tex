...
\begin{cventries}
  ...
  \cventry
    {Hands-on learning projects focused on backend systems}
    {Other Projects}
    {Personal Projects}
    {Ongoing}
    {
      \begin{cvitems}
        ...
        \item {\href{https://github.com/nmdra/Terraform-Learn}{\textbf{AWS and Terraform} \faGithub} — Provisioned and managed AWS and DigitalOcean infrastructure using Terraform.}
